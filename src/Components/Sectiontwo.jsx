...
function Sectiontwo() {
  return (
    <div className='flex justify-center items-center lg:h-screen h-full' style={{width:'100%'}}>
        <div className='backgroundsectwo bg-slate-400 lg:mt-5 mt-24 lg:mb-2 mb-12' style={{width:'90%',height:'80%',borderRadius:'3%'}}>
            <div className='flex flex-col justify-center items-center' style={{height:'100%',width:'100%'}}>
                <div className='flex lg:-ms-96'><i className="fa-solid fa-square text-blue-600 mt-1"></i><h3 className='ms-3 font-semibold'>The Best AI Service Provider</h3></div>
                <div className='mt-5 lg:ms-20' style={{fontSize:'50px'}}><h1 className='font-semibold'>Crafting Tomorrow's World with </h1><h1 className='font-semibold text-blue-600'>AI Excellence</h1></div>
                ...
                <div className='mt-4 flex flex-row lg:-ms-96'>
