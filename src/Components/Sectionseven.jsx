...
function Sectionseven() {
  return (
    <div className='flex lg:flex-row flex-col h-full w-full justify-evenly mb-10'>
        ...
        <div className='flex '>
            <i className="fa-solid fa-square text-blue-600 mt-1"></i><h3 className='ms-3 font-semibold'>PRODUCTS</h3></div>
            <div className='mt-5'><h1 className='font-semibold' style={{fontSize:'45px'}}>Our HR Tools</h1></div>
            <div className='mt-6'><h4 className='text-slate-500'>Our job grading and evaluation tool, combined with the <br />compensation management tool, is a highly effective SaaS- <br />based solution. It greatly assists HR consultants and <br /> managers in carrying out their roles with efficiency and <br />precision.</h4></div>
        </div>
        <div className='mt-24 bg-slate-100 lg:ms-0 ms-3 flex flex-col rounded items-center h-full' style={{width:'440px'}}>
            <div className='mt-8'><h2 className='' style={{fontSize:'25px'}}>Job Grading and Evaluation</h2></div>
            <div><h4 className='mt-5 text-slate-500'>Job evaluation assesses and ranks job roles in <br />an organization based on responsibilities and <br /> skills, often for compensation and structuring <br />purposes.</h4></div>
